"""
Test the simple API on port 8001
"""
...
def test_simple_api():
    """Test the simple API with the user's exact scenario."""
    
    print("🌐 TESTING SIMPLE API (PORT 8001)")
    print("=" * 50)
    
    # API endpoint
    url = "http://127.0.0.1:8001/analyze-personality"
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if has_identity:
                ...
                print("   👉 Context-aware filtering is working!")
        ...
        print("❌ Connection Error: Make sure the test API server is running on http://127.0.0.1:8001")
